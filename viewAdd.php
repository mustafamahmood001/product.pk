...
<body>
  ...
  WHERE  add_post.id = $addId";
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<p style='font-weight: 700; font-size:18px;margin-left: 1%; margin-top:1%;'>Category:</br> <span style='font-weight: 400; font-size:17px;'>" . $row['category'] . "</span></p>";
                        echo "<p style='font-weight: 700; font-size:18px;margin-left: 43%; margin-top:-9%;'>Sub Category:</br> <span style='font-weight: 400; font-size:17px;'>" . $row['sub_category'] . "</span></p>";
                        echo "<p style='font-weight: 700; font-size:18px;margin-left: 86%; margin-top:-9%;'>Brand:</br> <span style='font-weight: 400; font-size:17px;'>" . $row['brand'] . "</span></p>";
                        echo "<p style='font-weight: 700; font-size:18px;margin-left: 1%; margin-top:1%;'>Condition:</br> <span style='font-weight: 400; font-size:17px;'>" . $row['condition'] . "</span></p>";
                        echo "<p style='font-weight: 700; font-size:18px;margin-left: 43%; margin-top:-9%;'>Assembly:</br> <span style='font-weight: 400; font-size:17px;'>" . $row['assembly'] . "</span></p>";
                        echo "<p style='font-weight: 700; font-size:18px;margin-left: 86%; margin-top:-9%;'>Color:</br> <span style='font-weight: 400; font-size:17px;'>" . $row['color'] . "</span></p>";
                        echo "<p style='font-weight: 700; font-size:18px;margin-left: 1%; margin-top:1%;'>Price:</br> <span style='font-weight: 400; font-size:17px;'>" . $row['price'] . "</span></p>";
                        echo "<p style='font-weight: 700; font-size:18px;margin-left: 43%; margin-top:-9%;'>Quantity:</br> <span style='font-weight: 400; font-size:17px;'>" . $row['quantity'] . "</span></p>";
                        ...
                        echo "<p style='font-weight: 700; font-size:18px;margin-left: 1%;'>Seller name: <span style='font-weight: 400; font-size:17px;'>" . $row['seller_name'] . "</span></p>";
                        echo "<p style='font-weight: 700; font-size:18px;margin-left: 1%; margin-top:-1%;'>Contact number: <span style='font-weight: 400; font-size:17px;'>" . $row['mobile_number'] . "</span></p>";
