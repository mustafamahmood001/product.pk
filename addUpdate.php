...
$sql = "SELECT * FROM add_post WHERE id=$user_id";
$result = mysqli_query($conn, $sql);
...
if ($result->num_rows > 0) {
    ...
    $categorySelect = $row["category"];
    $subCategorySelect = $row["sub_category"];
    $brand = $row["brand"];
    ...
    $photos = explode(",", $row["image"]); // Split image names into an array
}
...
<div id="add">
            ...
            <div class="row" style="margin-top: 1%;">
                <div class="col-md-4">
                    <div class="form-outline">
                        ...
                        <input type="text" name="productName" id="productName" class="form-control form-control-lg" style="width: 96%;" value="<?php echo $productName; ?>" />
                    </div>
                    ...
                    <div class="form-outline">
                        ...
                        <select name="categorySelect" id="categorySelect" class="form-control form-control-lg" style="width: 96%;">
                            ...
                            while ($row = $getCategoryresult->fetch_assoc()) {
                                $selected = ($row['id'] == $categorySelect) ? 'selected' : '';
                            ?>
    ...
    <div class="form-outline">
        ...
        <select name="subCategorySelect" id="subCategorySelect" class="form-control form-control-lg" style="width: 96%;">
            <?php
            include 'productdatabase.php';
            $getSubCategories = "SELECT * FROM sub_category";
            $getSubCategoriesResult = mysqli_query($conn, $getSubCategories);
            while ($subCategoryRow = $getSubCategoriesResult->fetch_assoc()) {
                $selected = ($subCategoryRow['id'] == $subCategorySelect) ? 'selected' : '';
            ?>
                <option value="<?php echo $subCategoryRow['id'] ?>" <?php echo $selected ?>><?php echo $subCategoryRow['sub_category'] ?></option>
            <?php
            }
            ?>
        </select>
...
<div class="col-md-4">
    <div class="form-outline">
        ...
        <select name="brand" id="brand" class="form-control form-control-lg" style="width: 96%;">
            <?php
            // Populate this dropdown based on the selected sub-category
            if (!empty($subCategorySelect)) {
                $getBrands = "SELECT * FROM brands WHERE sub_category_id = $subCategorySelect";
                $getBrandsResult = mysqli_query($conn, $getBrands);
                while ($brandRow = $getBrandsResult->fetch_assoc()) {
                    $selected = ($brandRow['id'] == $brand) ? 'selected' : '';
                ?>
                    <option value="<?php echo $brandRow['id'] ?>" <?php echo $selected ?>><?php echo $brandRow['brand'] ?></option>
                <?php
                }
            }
            ?>
            ...
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <select name="condition" class="form-control form-control-lg" style="width: 96%">
                        <option value="" <?php if ($condition === "") echo 'selected="selected"'; ?>>Select Condition</option>
                        <option value="New" <?php if ($condition === "New") echo 'selected="selected"'; ?>>New</option>
                        <option value="Used" <?php if ($condition === "Used") echo 'selected="selected"'; ?>>Used</option>
                    </select>
                </div>
            ...
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <select name="assembly" class="form-control form-control-lg" style="width: 96%;">
                        <option value="" <?php if ($assembly === "") echo 'selected="selected"'; ?>>Select Assembly</option>
                        <option value="Imported" <?php if ($assembly === "Imported") echo 'selected="selected"'; ?>>Imported</option>
                        <option value="Local" <?php if ($assembly === "Local") echo 'selected="selected"'; ?>>Local</option>
                    </select>
                </div>
        ...
        <div class="row" style="margin-top: 1%;">
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <input type="number" name="price" class="form-control form-control-lg" style="width: 96%" value="<?php echo $price; ?>" placeholder="Enter the price" />
                </div>
            ...
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <input type="number" name="quantity" class="form-control form-control-lg" style="width: 96%" value="<?php echo $quantity; ?>" placeholder="Enter the quantity" />
                </div>
            ...
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <input type="text" name="color" class="form-control form-control-lg" style="width: 96%" value="<?php echo $color; ?>" placeholder="Enter the color" />
                </div>
        ...
        <div class="row" style="margin-top: 1%;">
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <input type="text" name="sellerName" class="form-control form-control-lg" style="width: 96%;" value="<?php echo $sellerName; ?>" placeholder="Enter your name" />
                </div>
            ...
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <input type="number" name="mobileNumber" class="form-control" style="width: 96%;" value="<?php echo $mobileNumber; ?>" placeholder="Enter your mobile number" />
                </div>
            ...
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <input type="text" name="address" class="form-control form-control-lg" style="width: 96%;" value="<?php echo $address; ?>" placeholder="Enter your address" />
                </div>
        ...
        <div class="row" style="margin-top: 1%;">
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <textarea name="productDescription" class="form-control" rows="4" style="width: 96%;" placeholder="Write the description of your product"><?php echo $productDescription; ?></textarea>
            ...
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <div class="uploaded-images">
                        <?php foreach ($photos as $photoName) : ?>
                            <img src="addImage/<?php echo $photoName; ?>" alt="Uploaded Image" width="100" height="100" />
                        <?php endforeach; ?>
                    </div>

                    <div class="col-md-4">
                        <button type="submit" class="btn btn-success" id="submitButton" name="addUpdate" style="width: 95%; height:55px; margin-top:20%; margin-left:100%">Update Add</button>
                    </div>
                </div>
            </div>
    </form>
