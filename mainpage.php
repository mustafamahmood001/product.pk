        ...
        <div class="login-form">
            ...
            <form action="" method="post">
                <div class="mb-2">
                    ...
                    <input type="username" class="form-control form-control-sm" name="username" id="username" aria-describedby="user_name" value="">
...
<div class="col-md-4">
        ...
        <input type="text" class="form-control form-control-sm" id="category1" name="category1" aria-describedby="category1" value="">
    </div>
    <div class="col-md-4">
    <label for="category" class="form-label">Category</label>
                    <input type="text" class="form-control form-control-sm" id="category" name="category" aria-describedby="category" value="">
    </div>